# Dotfiles for MacOS Configuration

When setup, the file in the `home` directory are linked to the `~`, acorrding to their respective names and paths. If you ever need to re-link, simply run the `link-dotfiles` command.
